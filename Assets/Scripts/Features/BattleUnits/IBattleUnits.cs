...
namespace Game
{
    public interface IBattleUnits : IFeature
    {
        ...
        UniTask ExecuteAttack(Vector2Int attackerCoordinate, Vector2Int targetCoordinate, int actionPoints);
        UniTask ExecuteMove(Vector2Int unitCoordinate, Vector2Int targetCoordinate, int actionPoints);
