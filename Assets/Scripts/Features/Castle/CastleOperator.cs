...
{
    /// <summary>
    /// Controls the visual state of a castle tile.
    /// Manages outline glow and mesh elevation between normal and highlighted states.
    /// </summary>
    public class CastleOperator : MonoBehaviour
    {
        ...
        /// <summary>
        /// Sets the castle to normal state: outline hidden, mesh at origin.
        /// </summary>
        ...
        /// <summary>
        /// Sets the castle to glowing state: outline visible, mesh elevated.
        /// </summary>
        ...
        /// <summary>
        /// Gets whether the castle is currently in glowing state.
        /// </summary>
        public bool IsGlowing => _isGlowing;

        /// <summary>
        /// Initializes the castle with its grid coordinate.
        /// </summary>
        ...
        /// <summary>
        /// Gets the coordinate of this castle in the grid.
        /// </summary>
